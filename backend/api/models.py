...
class PlantFamily(models.Model):
    ...
    name_english = models.CharField(
        max_length=100, blank=True, verbose_name="English Name")
    name_scientific = models.CharField(
        max_length=100, blank=True, verbose_name="Scientific Name")
    description_arabic = models.TextField(
        blank=True, verbose_name="Arabic Description")
...
# Add this to api/models.py at the end
