...
class AppConfig {
  ...
  static const String _stagingApiUrl = 'https://staging-api.your-domain.com/api';
  
  // For local development
  static const String _localApiUrl = 'http://10.0.2.2:8000/api'; // For Android emulator
  static const String _localIosApiUrl = 'http://localhost:8000/api'; // For iOS simulator
  
  // Your actual network IP (update this with your computer's IP address)
  static const String _networkIpApiUrl = 'http://192.168.1.100:8000/api'; // Change to your IP
  ...
  static String get apiBaseUrl {
    if (_environment == Environment.production) {
      ...
      if (kIsWeb) {
        ...
        // For desktop platforms or real devices, use the network IP
